        ...
        {recent.map((p, i) => {
          ...
          return (
            <Link
              ...
              className="reveal group flex flex-col bg-white rounded-2xl p-6 md:p-7 border border-ink-100 hover:border-ink-900 hover:-translate-y-1 hover:shadow-lift transition-all duration-200"
