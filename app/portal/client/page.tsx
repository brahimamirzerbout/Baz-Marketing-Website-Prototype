    ...
    <>
      <Section tone="paper" size="lg">
        ...
        <div className="max-w-3xl">
          ...
          <SectionLede>
            One link. Real-time access to your Marketing Hub. No &quot;let me pull
            the deck.&quot; No screenshots of dashboards. The same Hub your BAZ
            team is working in, every day.
          </SectionLede>
          <div className="mt-8 flex flex-wrap gap-3">
            <Button href={`${HUB_URL}/login`} external variant="primary" size="lg" trackAs="portal_login">
              Open your Hub →
            </Button>
      ...
      <Section tone="paper" size="lg">
        ...
        <div className="mt-8 grid md:grid-cols-2 gap-4">
          {[
            { t: 'Pipeline cockpit', d: 'Active deals, velocity, win rate, forecast. Updated every minute.' },
            { t: 'Triangle loop', d: 'Live state of the autonomous loop — score → route → step → close.' },
            { t: 'Attribution', d: 'Multi-touch attribution by channel. Know what actually moved the P&L.' },
            { t: 'Marketing Dive', d: 'Industry intelligence ingested daily. Your team reads it before planning.' },
