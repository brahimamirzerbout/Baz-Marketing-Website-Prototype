...
export const metadata = buildMetadata({
  title: 'Insights',
  description: 'Senior-team perspectives on SEO, paid media, content, analytics, AI search, and growth strategy. Written by the partners, not by content mills.',
  path: '/insights',
});
    ...
    <>
      <Section tone="paper" size="lg">
        ...
        <div className="max-w-4xl">
          ...
          <SectionLede>
            Six-pillar perspectives on what&apos;s actually working in growth marketing —
            written by the partners, not by content mills.
          </SectionLede>
        </div>
      </Section>
