...
export function generateMetadata({ params }: Params): Metadata {
  ...
  if (!post) return buildMetadata({ title: 'Post not found', path: `/insights/${params.slug}`, noindex: true });
  ...
  return (
    <>
      <Section tone="paper" size="lg">
        <Breadcrumb items={[{ label: 'Home', href: '/' }, { label: 'Insights', href: '/insights' }, { label: post.title }]} />
