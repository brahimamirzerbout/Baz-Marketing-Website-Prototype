...
const dimensions: Dimension[] = [
  { label: 'Senior team, no juniors',           baz: true,  them: 'mixed',   note: 'Most agencies pitch seniors, staff juniors. We name our team and ship with them.' },
  { label: 'Live client dashboard',             baz: true,  them: false,    note: 'The Marketing Hub. Real endpoints, not a PDF on the 15th.' },
  { label: 'Outcome-based pricing',             baz: true,  them: 'rare',    note: 'Pipeline added, ROAS, CAC. Tied to a real guarantee.' },
  { label: 'Speed guarantee in writing',        baz: true,  them: false,    note: '14 days or first month free. We\'ve never paid out.' },
  { label: 'Open methodology',                  baz: true,  them: false,    note: 'Scoring formula, attribution model, the triangle. All in /methodology.' },
  { label: 'Public POV (stance published)',     baz: true,  them: false,    note: 'Half the industry hedges. We publish positions, including the wrong ones.' },
  { label: 'Source code visible to clients',    baz: true,  them: false,    note: 'Your Hub source code is yours to read, audit, and own.' },
  { label: 'A la carte services',               baz: false, them: true,     note: 'We sell engagements, not hours. If you want one channel for $2K/mo, we\'re not the right fit.' },
  { label: 'Industry awards on the wall',       baz: false, them: true,     note: 'Cannes, Effies, Webbys. We don\'t enter. We ship.' },
  { label: 'Local-only (one city)',             baz: false, them: true,     note: 'We work MENA, EU, US. Remote-first. No office, no lease, no overhead.' },
];
    ...
    <>
      <Section tone="paper" size="lg">
        ...
        <div className="max-w-3xl">
          ...
          <SectionLede>
            Other agencies do things we don&apos;t. We do things they don&apos;t.
            This page is so you can tell in five minutes whether we&apos;re the
            right fit — and so we don&apos;t waste your time if we&apos;re not.
          </SectionLede>
        </div>
      </Section>
      ...
      <Section tone="paper" size="lg">
        ...
        <div className="mt-12">
          <h2 className="font-display text-display-lg font-medium tracking-[-0.03em] mb-6">So, are we the right fit?</h2>
