...
export const templates = [
  { id: 'og-card',       name: 'OG card',          w: 1200, h: 630, desc: 'For blog & case study social previews.' },
  { id: 'case-cover',    name: 'Case study cover', w: 1600, h: 900, desc: 'Hero image for case study pages.' },
  { id: 'ad-square',     name: 'Ad — square',      w: 1080, h: 1080, desc: 'Instagram / LinkedIn carousel opener.' },
